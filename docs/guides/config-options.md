...
Configurable options are a powerful feature which allow your customer to customise their product. You can create configurable options for any product.
...
![Configurable Options Overview](/assets/images/guides/config-options/configurable-options-overview.png)
...
The `Name` variable is once again what is shown to your customer upon reaching the configurable options window!
